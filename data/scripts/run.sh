...
python $fairseq_dir/preprocess.py \
    ...
    --source-lang src \
    --target-lang trg \
    --trainpref $temp_traindata_dir/train \
    --validpref $temp_traindata_dir/dev \
    --destdir $temp_traindata_dir/fairseq_preprocess \
    --workers 40 \
    --joined-dictionary

#python $script_dir/edit_weights.py -s $temp_traindata_dir/train.src -t $temp_traindata_dir/train.trg -o $temp_traindata_dir/train.align -v $temp_traindata_dir/dict.align.txt

#python $fairseq_dir/preprocess.py \
#    --srcdict $temp_traindata_dir/dict.align.txt \
#    -s align \
#    --only-source \
#    --trainpref $temp_traindata_dir/train \
#    --destdir $temp_traindata_dir/fairseq_preprocess_2 \
#    --workers 40 \
